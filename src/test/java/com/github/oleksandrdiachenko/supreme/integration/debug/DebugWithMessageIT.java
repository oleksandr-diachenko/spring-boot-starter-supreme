package com.github.oleksandrdiachenko.supreme.integration.debug;

import com.github.oleksandrdiachenko.supreme.TestConfig;
import com.github.oleksandrdiachenko.supreme.integration.testinstance.debug.DebugWithMessageInstance;
...
@SpringBootTest(classes = TestConfig.class, properties = "logging.level.com.github.oleksandrdiachenko.supreme.integration.testinstance.debug=DEBUG")
@ExtendWith({SpringExtension.class, OutputCaptureExtension.class})
class DebugWithMessageIT {

    @Autowired
    private DebugWithMessageInstance instance;
