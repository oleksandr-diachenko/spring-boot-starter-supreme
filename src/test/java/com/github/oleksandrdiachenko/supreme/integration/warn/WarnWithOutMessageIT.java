package com.github.oleksandrdiachenko.supreme.integration.warn;

import com.github.oleksandrdiachenko.supreme.TestConfig;
import com.github.oleksandrdiachenko.supreme.integration.testinstance.warn.WarnWithoutMessageInstance;
...
@SpringBootTest(classes = TestConfig.class, properties = "logging.level.com.github.oleksandrdiachenko.supreme.integration.testinstance=WARN")
@ExtendWith({SpringExtension.class, OutputCaptureExtension.class})
class WarnWithOutMessageIT {

    @Autowired
    private WarnWithoutMessageInstance instance;
